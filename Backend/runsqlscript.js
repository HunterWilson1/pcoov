...
const balsamicData = [
  ...
  },
  {
    ...
    description:
      "The Blenheim variety is both sweet and tart with an intensely aromatic aroma of honeysuckle and picked with a faint green tinge. We married this with our aged white balsamic condimento. The resulting collaboration, is intoxicating as it is crisp and tart. Great with grilled chicken, as a glaze or served with cheese.",
    pairings: [],
  },
  {
    ...
    description:
      "Playfully tart and pleasantly sweet, our Sicilian Lemon White Balsamic has perfectly balanced acidity and a crisp, lemon flavor and aroma. Fabulous with seafood, in dressings or in mixed drinks.",
    pairings: [],
  },
  {
    ...
    description:
      "Juicy, tart raspberry and luscious white balsamic come together in this bright, versatile infused balsamic. Use it in shrubs, mixed cocktails, as a glaze or marinade for poultry, in wilted spinach salad, over fresh cut fruit, to glaze salmon, and much, much more!",
    pairings: [],
  },
  {
    name: "Peach Balsamic",
  ...
  },
  {
    ...
    description:
      "Sweet, spicy, and tart, like you would expect from this chili-infused condiment. Use this to light up your marinades, splash in ceviche, spice up a salsa, or blend into a dressing to top fruits or salads.",
    pairings: [],
  },
  {
    ...
    description:
      "Honey and ginger play well together and bring a gentle, spicy heat which balances perfectly with the moderate, natural acidity of our white balsamic vinegar. Wonderful with seafood, vinaigrettes, pork, and chicken. Creates a zing for those Asian dishes!",
    pairings: [],
  },
  {
    ...
    description:
      "If you take a hint of apricot, combine it with the floral note of golden-ripe Japanese plums, and the luscious, sweet-tart characteristics of our aged white balsamic from Modena, Italy.",
    pairings: [],
  },
  {
  ...
  },
  {
    ...
    description:
      "Our Coconut White Balsamic is wonderfully sweet, pleasingly tart, and redolent with the clean, natural flavor of coconut. It makes a fantastic dressing or marinade and is divine paired with our Persian Lime Olive oil.",
    pairings: [],
  },
  {
    ...
    description:
      "Use our sweet, floral Key Lime White Balsamic in shrubs, marinades, mixed cocktails, pickles, over berries, or cut up fruit. Makes a wonderful glaze or addition to marinades and dressings. Excellent when mixed with sparkling water for a refreshing, crisp beverage.",
    pairings: [],
  },
  {
    ...
    description:
      "Fantastic with shrimp, scallops, salad, and in salsas for a tropical, sweet-tart twist! The Alfoos mango cultivar is considered by many to be one of the best in terms of sweetness, richness, and flavor.",
    pairings: [],
  },
  {
    ...
    description:
      "Our Golden Pineapple Balsamic is sweet and tart with the heady aroma of fresh ripe pineapple. This amazing, zesty balsamic is the perfect complement to fruit salads and fresh berries. Adds substantial flavor without discoloring salads.",
    pairings: [],
  },
  {
    ...
    description:
      "Our Grapefruit White Balsamic sparkles with crisp, clean citrus flavor. It has a perfect balance of acidity and natural sweetness. Try this amazing balsamic in dressings, paired with fennel. It makes a show-stopping white balsamic grapefruit granita.",
    pairings: [],
  },
  {
    ...
    description:
      "This sparkling ruby jewel-toned white balsamic owes its tart, crisp flavor to Juicy California Grenadines and Floral Winter Quince. It's made from authentic white balsamic condimento, aged for up to 12 years in Modena, Italy.",
    pairings: [],
  },
  {
    ...
    description:
      "This confectionary white balsamic condimento is aged for up to 12 years in Modena, Italy. It's made from creamy, sultry Madagascar Vanilla and bright, fruity Cara Cara Orange. Absolutely delightful with chocolate, fruit salads, in sparkling water, mixed drinks, or drizzled over yogurt and vanilla ice cream.",
    pairings: [],
  },
  {
    ...
    description:
      "The Gravenstein Apple is prized for its amazing ambrosia perfume, and crisp, sweet-tart flavor. This balsamic captures the essence of this prized apple and is great in marinades, on salads, or drizzled over grilled chicken.",
    pairings: [],
  },
  {
    ...
    description:
      "A refreshing take on balsamic, featuring the light and crisp flavor of cucumber. It's perfect for dressing salads or as a marinade for summer vegetables, adding a unique twist to your dishes.",
    pairings: [],
  },
  {
    ...
    description:
      "A perfect blend of heat from serrano peppers and sweetness from honey, this balsamic is ideal for adding a spicy kick to your marinades or as a glaze for grilled meats.",
    pairings: [],
  },
  {
    ...
    description:
      "Rich and sweet with a tart edge, this balsamic brings the flavor of ripe strawberries to your dishes. Perfect for dressing salads, drizzling over desserts, or as a dip for fresh fruits.",
    pairings: [],
  },
  {
    ...
    description:
      "The luscious taste of blueberries infuses this balsamic, making it a wonderful addition to salads, cheeses, or even cocktails for a fruity twist.",
    pairings: [],
  },
  {
    ...
    description:
      "This balsamic vinegar oozes with the natural flavor of fresh, ripe raspberries. It's perfectly balanced, making it an ideal addition to both savory dishes and desserts.",
    pairings: [],
  },
  {
    ...
    description:
      "A unique combination of juicy blackberries and fiery ginger, this balsamic is a game-changer for marinades and glazes, offering a spicy kick that is sure to delight.",
    pairings: [],
  },
  {
    ...
    tags: "balsamic, sweet, fruity, red, desserts, sweets, modern, cheese, fruits, bold",
    description:
      "Sweet, rich, and bursting with the flavor of dark cherries, this balsamic is a luxurious addition to desserts, salads, and meats, providing a deep fruitiness that enriches every bite.",
    pairings: [],
  },
  {
    ...
    description:
      "The intense flavor of pomegranate makes this balsamic a perfect match for robust salads, meats, and cheeses, offering a tartness that elevates the dish's flavors.",
    pairings: [],
  },
  {
    ...
    tags: "balsamic, sweet, fruity, red, desserts, sweets, modern, cheese, fruits, medium",
    description:
      "Deep, rich, and luscious, this balsamic boasts the natural flavor of black currant. It's perfect for drizzling over desserts, mixing into cocktails, or adding a fruity depth to sauces and marinades.",
    pairings: [],
  },
  {
    ...
    description:
      "Sweet with a hint of tartness, our Mission Fig Balsamic vinegar is a harmonious blend of ripe figs and aged balsamic. Ideal for dressing salads, drizzling over cheeses, or enhancing sauces with its rich, figgy depth.",
    pairings: [],
  },
  {
    name: "Maple Balsamic",
    ...
    description:
      "Infused with the natural sweetness of maple, this balsamic adds a warm, comforting touch to dishes. Use it as a marinade for meats, a glaze for roasted vegetables, or a drizzle over pancakes for a gourmet touch.",
    pairings: [],
  },
  {
    ...
    description:
      "The warm spice of cinnamon and the sweet juiciness of pears combine in this balsamic to create a flavor that's both comforting and invigorating. Perfect for autumn dishes, drizzled over desserts, or added to warm beverages.",
    pairings: [],
  },
  {
    ...
    description:
      "Rich and intense, our Espresso Balsamic captures the essence of freshly brewed espresso. Ideal for adding depth to desserts, glazes, and marinades, or for creating an extraordinary vinaigrette.",
    pairings: [],
  },
  {
    ...
    description:
      "Crisp and delightfully sweet, this balsamic brings the flavor of fresh red apples to your table. Excellent for dressing salads, drizzling over desserts, or adding a fresh twist to sparkling water.",
    pairings: [],
  },
  {
    ...
    description:
      "This velvety balsamic combines the luxurious richness of dark chocolate with the tangy depth of aged balsamic. A dream for drizzling over strawberries, ice cream, or adding an unexpected twist to savory dishes.",
    pairings: [],
  },
  {
    ...
    description:
      "Infused with the exotic flavor of Tahitian vanilla, this balsamic is a sweet, floral delight. Enhance the flavor of fresh fruits, desserts, or use it to create a memorable vinaigrette.",
    pairings: [],
  },
  {
    ...
    description:
      "Brimming with the flavors of Italian herbs, this balsamic is a must for creating marinades or dressings that sing with herbal goodness. Perfect for elevating grilled meats or roasted vegetables.",
    pairings: [],
  },
  {
    ...
    description:
      "Vibrant and zesty, our Tangerine Balsamic is a citrus lovers dream. Use it to brighten up salads, marinades, or add a splash to sparkling water for a refreshing beverage.",
    pairings: [],
  },
  {
    ...
    description:
      "Delicately floral and slightly sweet, our Lavender Balsamic adds a touch of elegance to any dish. Ideal for drizzling over soft cheeses, fresh fruits, or adding a floral note to salads and marinades.",
    pairings: [],
  },
  {
    ...
    description:
      "A sophisticated and robust balsamic, perfect for those who appreciate the complexity of aged vinegar. Use it to add depth to reductions, marinades, or even as a luxurious drizzle over steak.",
    pairings: [],
  },
  {
    ...
    description:
      "Our finest balsamic, aged for up to 18 years for unmatched depth and complexity. A treasure in any kitchen, it is perfect for enhancing the flavors of cheeses, fruits, and even ice cream.",
    pairings: [],
  },
  {
    ...
    description:
      "The pinnacle of our balsamic collection, Denissimo is crafted for those who demand the very best. Its rich, decadent flavor is ideal for finishing dishes, from meats to desserts, adding a note of luxury.",
    pairings: [],
  },
  {
...
const seedDatabase = async () => {
  ...
  await OliveOil.bulkCreate(oliveOilsData);
