...
const LandingPage = () => {
  ...
  const backgroundStyle = {
    ...
    backgroundImage: `url(${
      isOliveOilQuiz ? olivebackground : balsamicbackground
    })`,
  ...
  <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mt-6 mb-4 text-green-700">
  ...
  <Link to={quizLink} className="block w-full text-center">
    <button
      className={`mx-auto bg-lime-500 hover:bg-lime-600 text-white px-4 py-2 rounded shadow-lg transform transition duration-300 ease-in-out hover:scale-105`}
